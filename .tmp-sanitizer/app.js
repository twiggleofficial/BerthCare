...
const configuredMax = Number.parseInt(
  (_a = process.env.RATE_LIMIT_MAX) !== null && _a !== void 0 ? _a : '100',
  10
);
const rateLimitMax = Number.isNaN(configuredMax) ? 100 : configuredMax;
const allowedOrigins =
  (_c =
    (_b = process.env.ALLOWED_ORIGINS) === null || _b === void 0
      ? void 0
      : _b
          .split(',')
          .map((origin) => origin.trim())
          .filter((origin) => origin.length > 0)) !== null && _c !== void 0
    ? _c
    : undefined;
...
exports.app.use((req, res, next) => {
  ...
  res.on('finish', () => {
    ...
    const sanitizedUrl = sanitizeUrl(
      (_b = (_a = req.originalUrl) !== null && _a !== void 0 ? _a : req.url) !== null &&
        _b !== void 0
        ? _b
        : ''
    );
...
exports.app.get('/health', async (_req, res, next) => {
  ...
  try {
    const [dbHealth, redisHealth, storageHealth] = await withTimeout(
      Promise.all([
        (0, pool_1.checkDatabaseConnection)(),
        (0, redis_1.checkRedisConnection)(),
        (0, s3_1.checkPhotoBucketHealth)(),
      ]),
