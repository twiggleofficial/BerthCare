...
const processLogger = (logger_1 === null || logger_1 === void 0 ? void 0 : logger_1.processLogger) || (logger_1 === null || logger_1 === void 0 ? void 0 : logger_1.logger);
const logBlacklistError = (operation, key, error) => {
    ...
    if (processLogger && typeof processLogger.error === 'function') {
        processLogger.error(`Failed to ${operation} access token blacklist entry`, { ...context, error });
    }
    else {
