...
export type DatabaseHealthState = 'ok' | 'error';
...
const initializePool = async (createdPool: Pool): Promise<void> => {
...
const attachPoolEventHandlers = (createdPool: Pool) => {
  ...
  createdPool.on('error', (error: Error) => {
